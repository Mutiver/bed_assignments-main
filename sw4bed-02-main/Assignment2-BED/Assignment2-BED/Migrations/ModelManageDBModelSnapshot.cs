...
{
    [DbContext(typeof(ModelManageDB))]
    partial class ModelManageDBModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment2_BED.Models.Expense", b =>
                {
            ...
            modelBuilder.Entity("Assignment2_BED.Models.Job", b =>
                {
                    b.Property<long>("JobId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Assignment2_BED.Models.Model", b =>
                {
                    b.Property<long>("ModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Assignment2_BED.Models.Expense", b =>
                {
                    b.HasOne("Assignment2_BED.Models.Job", null)
                        .WithMany("Expenses")
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Assignment2_BED.Models.Model", null)
                        .WithMany("Expenses")
